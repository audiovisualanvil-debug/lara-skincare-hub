  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        rose: "bg-gradient-rose text-primary-foreground shadow-soft hover:shadow-glow hover:scale-[1.02]",
        gold: "bg-gradient-gold text-primary-foreground shadow-soft hover:shadow-card hover:scale-[1.02]",
        elegant: "bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground",
        whatsapp: "bg-[hsl(145,70%,40%)] text-primary-foreground hover:bg-[hsl(145,70%,35%)] shadow-soft hover:shadow-card",
      },
      size: {
